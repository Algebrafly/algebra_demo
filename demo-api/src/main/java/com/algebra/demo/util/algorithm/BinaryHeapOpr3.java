 ...
 */
public class BinaryHeapOpr3<E extends Comparable> implements Cloneable, java.io.Serializable {
     ...
     */
    public BinaryHeapOpr3(boolean isMaxHeap) {
     ...
     */
    public BinaryHeapOpr3(boolean isMaxHeap, int initialCapacity) {
    ...
    public Object clone() {
        try {
            BinaryHeapOpr3<?> v = (BinaryHeapOpr3<?>) super.clone();

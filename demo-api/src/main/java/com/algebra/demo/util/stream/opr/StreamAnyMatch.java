 ...
 * @description
 */
public class StreamAnyMatch<T extends Integer> implements StreamOperation<T> {
    ...
    public void doMidOperator() {
        boolean b = this.integerStream.anyMatch(i -> i > 3);
        System.out.println(b ? "存在大于3的值" : "值都小于3");
    }

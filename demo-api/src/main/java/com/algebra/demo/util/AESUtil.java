...
public class AESUtil {
    ...
    public static void main(String[] args) {
        ...
        JSONObject object = JSONObject.parseObject(dealData);
        log.info("数据解密,加密的数据:{}, \n 解密的数据:{}",bodyStr,
                JSON.toJSONString(object, SerializerFeature.PrettyFormat, SerializerFeature.WriteMapNullValue, SerializerFeature.WriteDateUseDateFormat));

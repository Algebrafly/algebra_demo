...
public class DataSourcesAutoConfiguration implements TransactionManagementConfigurer {
    ...
    @Autowired
    private SlaveDataSourceConfig customDataSourceConfig;

    @Override
    public PlatformTransactionManager annotationDrivenTransactionManager() {

        return new ChainedTransactionManager(masterDataSourceConfig.masterTransactionManager(), customDataSourceConfig.slaveTransactionManager());
    }
}